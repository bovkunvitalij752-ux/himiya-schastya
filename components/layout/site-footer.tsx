        ...
        <div className="grid gap-10 border-b border-white/10 p-6 sm:p-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:p-10">
          <div>
            ...
            <p className="mt-6 max-w-sm text-sm leading-7 text-white/62">
              Платформа для диагностики отношений, консультаций и бережного сопровождения пар с помощью психологии,
              осознанности и искусственного интеллекта.
            </p>
          </div>

          <div>
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-[#ffd58c]">Продукт</h2>
          ...
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-[#ffd58c]">Компания</h2>
            <div className="mt-5 grid gap-3">
          ...
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-[0.18em] text-[#ffd58c]">Связь</h2>
            <a
